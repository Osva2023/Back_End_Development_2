...
const createAgent = async (req, res) => {
  ...
  return res
    .status(200)
    .send({ message: "Agent created successfully", data: agentCheck });
};
...
const sortingAgents = async (req, res) => {
  ...
  return res
    .status(200)
    .send({ message: "Agents sorted successfully", data: sortedAgents });
};
const byratingAgents = async (req, res) => {
  ...
  return res
    .status(200)
    .send({ message: "List of agents sorted by rating", data: sortedAgents });
};
const updatingAgent = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .send({ message: "Agent updated successfully", data: agent });
  } catch (error) {
